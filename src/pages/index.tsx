  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Welcome to HR Information System - your comprehensive solution for managing employee data, vacations, and payroll with ease and efficiency." />
      ...
      <Image flex="1" src={'https://images.unsplash.com/photo-1573496130407-57329f01f769?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxodW1hbiUyMHJlc291cmNlc3xlbnwwfHx8fDE2OTc1MjY5MDB8MA&ixlib=rb-4.0.3&q=80&w=1080'} alt="Dinner" objectFit="cover" objectPosition="center" />
      <Box
        position="absolute"
        top="0"
