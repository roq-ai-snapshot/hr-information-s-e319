...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const queryParams = useMemo(() => convertQueryToPrismaUtil({
    ...
    ...params.filters,
  }, 'employee'), [params.searchTerm, params.filters, params.pageNumber, params.order, params.pageSize])
...
hasAccess('company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) ?
          ...
          <Link
            as={NextLink}
            onClick={(e) => e.stopPropagation()}
            href={`/companies/view/${record.company?.id}`}>{record.company?.name}
          </Link>
        ),
      } : null
    ,
...
hasAccess('vacation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) ? {
          id: 'vacation', header: 'Vacation', accessorKey: 'vacation',
