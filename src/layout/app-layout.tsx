...
import {
  ...
  FiBriefcase, FiDollarSign, FiUserCheck, FiSun, FiUserPlus
} from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const isActiveRoute = useCallback(
   ...
   const { data, error, isLoading } = useCompanyFindFirst({ where: { tenant_id: session?.user?.tenantId }}, {}, { disabled: !session?.user?.tenantId})
  loading = isLoading;
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: "Companies", path: isTenantUser? `/companies/view/${data?.id}`  :"/companies", entity: "company", service: AccessServiceEnum.PROJECT, icon: FiBriefcase  },
{ name: "Employees", path: "/employees", entity: "employee", service: AccessServiceEnum.PROJECT, icon: FiUserCheck  },
{ name: "Hr Managers", path: "/hr-managers", entity: "hr_manager", service: AccessServiceEnum.PROJECT, icon: FiUserPlus  },
