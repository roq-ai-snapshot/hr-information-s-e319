...
interface Hr_managerSDK {
  ...
  findMany: <T extends Prisma.hr_managerFindManyArgs, R extends GetFindResult<Prisma.$hr_managerPayload<DefaultArgs>, T>[]>(
  ...
  findFirst: <T extends Prisma.hr_managerFindFirstArgs, R extends GetFindResult<Prisma.$hr_managerPayload<DefaultArgs>, T>>(
...
export class RoqClient {
  ...
  private initSDK() {
    ...
    this.employee = {
      ...
      update: async function updateEmployee<T extends Prisma.employeeUpdateArgs, R extends Prisma.employeeGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.employeeUpdateArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
      ...
      upsert: async function upsertEmployee<T extends Prisma.employeeUpsertArgs, R extends Prisma.employeeGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.employeeUpsertArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
      ...
      delete: async function deleteEmployee<T extends Prisma.employeeDeleteArgs, R extends Prisma.employeeGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.employeeDeleteArgs>,
        options?: RequestOptions,
      ) {
    ...
    this.hr_manager = {
      ...
      update: async function updateHr_manager<T extends Prisma.hr_managerUpdateArgs, R extends Prisma.hr_managerGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.hr_managerUpdateArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
      ...
      upsert: async function upsertHr_manager<T extends Prisma.hr_managerUpsertArgs, R extends Prisma.hr_managerGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.hr_managerUpsertArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
      ...
      delete: async function deleteHr_manager<T extends Prisma.hr_managerDeleteArgs, R extends Prisma.hr_managerGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.hr_managerDeleteArgs>,
        options?: RequestOptions,
      ) {
    ...
    this.vacation = {
      ...
      update: async function updateVacation<T extends Prisma.vacationUpdateArgs, R extends Prisma.vacationGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.vacationUpdateArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
      ...
      upsert: async function upsertVacation<T extends Prisma.vacationUpsertArgs, R extends Prisma.vacationGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.vacationUpsertArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
      ...
      delete: async function deleteVacation<T extends Prisma.vacationDeleteArgs, R extends Prisma.vacationGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.vacationDeleteArgs>,
        options?: RequestOptions,
      ) {
